...
# Proxy settings
# Restsh uses the system proxy settings (https_proxy and http_proxy environment variables)
[ -n "${RESTSH_CURL_PROXY_INSECURE+x}" ] || RESTSH_CURL_PROXY_INSECURE="0"
[ -n "${RESTSH_CURL_PROXY_AUTH+x}" ] || RESTSH_CURL_PROXY_AUTH="anonymous"
#[ -n "${RESTSH_CURL_PROXY_AUTH+x}" ] || RESTSH_CURL_PROXY_AUTH="basic"
#[ -n "${RESTSH_CURL_PROXY_USER+x}" ] || RESTSH_CURL_PROXY_USER=""
#[ -n "${RESTSH_CURL_PROXY_PASS+x}" ] || RESTSH_CURL_PROXY_PASS=""
